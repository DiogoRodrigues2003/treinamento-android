...
import br.com.cwi.nespresso_app.presentation.feature.products.machineDetails.MachineDetailsActivity
import com.bumptech.glide.Glide

class MachineViewHolder(item: View) : RecyclerView.ViewHolder(item) {
    private val contentMachine = ItemMachineBinding.bind(item).contentMachine
